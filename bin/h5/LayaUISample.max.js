...
*
*@author ZLM
*@date 2020-10-28下午8:45:59
*/
//class com.control.event.GameEvents
...
var GameControl=(function(){
	...
	__proto.changeScene=function(_pass,isInit){
		...
		this.mapMgr.changeMap(_pass);
	}

	__getset(1,GameControl,'ins',function(){
		return GameControl._ins=GameControl._ins|| new GameControl();
	});

	GameControl._ins=null;
	return GameControl;
})()
...
var GameDataMgr=(function(){
	...
	__class(GameDataMgr,'com.control.GameDataMgr');
	var __proto=GameDataMgr.prototype;
	/**当前关卡*/
	__getset(0,__proto,'passNum',function(){
		return this._passNum;
		},function(value){
		this._passNum=value;
	});

	__getset(1,GameDataMgr,'ins',function(){
		return GameDataMgr._ins=GameDataMgr._ins|| new GameDataMgr();
	});

	GameDataMgr._ins=null;
	return GameDataMgr;
})()
...
var MapMgr=(function(){
	...
	var __proto=MapMgr.prototype;
	__proto.changeMap=function(_pass){
		this.tmap=new TiledMap();
		var vrect=new Rectangle(0,0,Browser.width,Browser.height);
		this.tmap.createMap("res/tiledMap/pass"+_pass+".json",vrect,Handler.create(this,this.loadCom,[_pass]));
	}
	...
	__proto.getLayer=function(name){
		var sp=this.tmap.getLayerByName(name);
		return sp;
	}
	...
	__getset(1,MapMgr,'ins',function(){
		return MapMgr._ins=MapMgr._ins|| new MapMgr();
	});
...
*/
//class com.data.Configs
var Configs=(function(){
	function Configs(){}
	__class(Configs,'com.data.Configs');
...
*
*@author ZLM
*@date 2020-10-28下午8:58:36
*/
//class com.data.GameInfo
var GameInfo=(function(){
	...
	__class(GameInfo,'com.data.GameInfo');
	return GameInfo;
})()
...
var Context=(function(){
	...
	__proto.strokeText=function(text,x,y,font,color,lineWidth,textAlign){
		...
		if ((typeof font=='number')){
			this.__strokeText(text,x,y,font);
		}else
		this.__strokeText(text,x,y);
	}
	...
	Context.__init__=function(to){
		...
		to=to || window.CanvasRenderingContext2D.prototype;
		if (to.inited)return;
		to.inited=true;
...
var WebGL=(function(){
	...
	WebGL.enable=function(){
		...
		RunDriver.clear=function (color){
			...
			var c=color && (ctx._submits._length==0 || Config.preserveDrawingBuffer)? Color$1.create(color)._color :Stage._wgColor;
...
*/
//class com.control.event.EventCent extends laya.events.EventDispatcher
var EventCent=(function(_super){
	function EventCent(){
		EventCent.__super.call(this);
	}

	__class(EventCent,'com.control.event.EventCent',_super);
	__getset(1,EventCent,'ins',function(){
		return EventCent._ins=EventCent._ins|| new EventCent();
...
var Game=(function(_super){
	...
	__class(Game,'com.View.Game',_super);
...
*/
//class com.View.player.Hero extends laya.display.Sprite
var Hero=(function(_super){
	...
	__proto.changeAction=function(actType){
		switch(actType){
			case 2:
				break ;
			default :
